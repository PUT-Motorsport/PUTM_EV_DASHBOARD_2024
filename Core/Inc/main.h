...
#define RADIO_BT_Pin GPIO_PIN_11
#define RADIO_BT_GPIO_Port GPIOH
#define SS_BTN_Pin GPIO_PIN_0
#define SS_BTN_GPIO_Port GPIOB
#define R_CS_Pin GPIO_PIN_1
#define R_CS_GPIO_Port GPIOG
#define DRS_BT_Pin GPIO_PIN_3
#define DRS_BT_GPIO_Port GPIOA
