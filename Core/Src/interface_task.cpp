...
void Interface_Task(void *argument) {
	for (;;) {
		...
		if (interfaceData.rtd_button_prev != interfaceData.rtd_button ||
			interfaceData.tsa_button_prev != interfaceData.tsa_button ||
			interfaceData.usr_button_prev != interfaceData.usr_button) {
			interfaceData.state_changed = true;

			interfaceData.rtd_button_prev = interfaceData.rtd_button;
			interfaceData.tsa_button_prev = interfaceData.tsa_button;
			interfaceData.usr_button_prev = interfaceData.usr_button;
		}
