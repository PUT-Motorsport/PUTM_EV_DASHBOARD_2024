...
static int32_t OSPI_NOR_EnterSOPIMode(OSPI_HandleTypeDef* hospi) {
    ...
    else if(MX25LM51245G_WriteCfg2Register(hospi, MX25LM51245G_SPI_MODE, MX25LM51245G_STR_TRANSFER, MX25LM51245G_CR2_REG3_ADDR, MX25LM51245G_CR2_DC_6_CYCLES) !=
            MX25LM51245G_OK) {
        ret = 1;
    }
    /* Enable write operations */
    ...
    else if(MX25LM51245G_WriteCfg2Register(hospi, MX25LM51245G_SPI_MODE, MX25LM51245G_STR_TRANSFER, MX25LM51245G_CR2_REG1_ADDR, MX25LM51245G_CR2_SOPI) !=
            MX25LM51245G_OK) {
        ret = 1;
    } else {
