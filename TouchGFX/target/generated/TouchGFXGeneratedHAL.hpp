...
class TouchGFXGeneratedHAL : public touchgfx::HALGPU2D {
  public:
    /**
     * @fn TouchGFXGeneratedHAL::TouchGFXGeneratedHAL(touchgfx::DMA_Interface& dma, touchgfx::LCD& display, touchgfx::TouchController& tc, uint16_t width,
     * uint16_t height) : touchgfx::HALGPU2D(dma, display, tc, width, height)
     *
     * @brief Constructor.
     *
