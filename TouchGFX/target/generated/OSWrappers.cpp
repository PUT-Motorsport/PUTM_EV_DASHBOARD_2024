 ...
 */
void OSWrappers::takeFrameBufferSemaphore() { osSemaphoreAcquire(frame_buffer_sem, osWaitForever); }

/*
 * Release the frame buffer semaphore.
 */
void OSWrappers::giveFrameBufferSemaphore() { osSemaphoreRelease(frame_buffer_sem); }
 ...
 */
void OSWrappers::tryTakeFrameBufferSemaphore() { osSemaphoreAcquire(frame_buffer_sem, 0); }
 ...
 * Called from ISR.
 */
void OSWrappers::giveFrameBufferSemaphoreFromISR() { osSemaphoreRelease(frame_buffer_sem); }
 ...
 */
void OSWrappers::taskDelay(uint16_t ms) { osDelay(static_cast<uint32_t>(ms)); }
 ...
 */
void OSWrappers::taskYield() { osThreadYield(); }
